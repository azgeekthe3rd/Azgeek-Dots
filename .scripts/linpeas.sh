#!/bin/sh
#sauce: https://github.com/carlospolop/PEASS-ng/tree/master/linPEAS
...
if echo $CHECKS | grep -q ProCronSrvcsTmrsSocks || echo $CHECKS | grep -q IntFiles || echo $CHECKS | grep -q SofI; then
  ...
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find /applications -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find /bin -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find /.cache -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find /cdrom -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find /etc -type d -name \"system.d\" -o -name \"bind\" -o -name \"couchdb\" -o -name \"postfix\" -o -name \"cacti\" -o -name \"environments\" -o -name \"ldap\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \".cloudflared\" -o -name \"sentry\" -o -name \".irssi\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find /media -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find /mnt -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find /opt -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find /private -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find /sbin -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find /snap -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find /srv -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find /tmp -type d -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" -o -name \"seeddms*\" -o -name \"couchdb\" -o -name \".cloudflared\" -o -name \"postfix\" -o -name \"sentry\" -o -name \"cacti\" -o -name \"environments\" -o -name \".irssi\" -o -name \"ldap\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find /usr -type d -name \"bind\" -o -name \"couchdb\" -o -name \"postfix\" -o -name \"cacti\" -o -name \"environments\" -o -name \"ldap\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \".cloudflared\" -o -name \"sentry\" -o -name \".irssi\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find /var -type d -name \"bind\" -o -name \"couchdb\" -o -name \"postfix\" -o -name \"cacti\" -o -name \"environments\" -o -name \"ldap\" -o -name \"neo4j\" -o -name \"sites-enabled\" -o -name \"seeddms*\" -o -name \".cloudflared\" -o -name \"sentry\" -o -name \".irssi\" -o -name \"mysql\" -o -name \".vnc\" -o -name \".bluemix\" -o -name \"logstash\" -o -name \"keyrings\" -o -name \"filezilla\" -o -name \".svn\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_APPLICATIONS=`eval_bckgrd "find /applications -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find /bin -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find /.cache -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find /cdrom -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find /etc -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \"*knockd*\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"ssh*config\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_MEDIA=`eval_bckgrd "find /media -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_MNT=`eval_bckgrd "find /mnt -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"sess_*\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_OPT=`eval_bckgrd "find /opt -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_PRIVATE=`eval_bckgrd "find /private -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"agent*\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"sess_*\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_RUN=`eval_bckgrd "find /run -name \"*.service\" -o -name \"*.socket\" -o -name \"*.timer\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SBIN=`eval_bckgrd "find /sbin -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SNAP=`eval_bckgrd "find /snap -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_SRV=`eval_bckgrd "find /srv -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_TMP=`eval_bckgrd "find /tmp -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"agent*\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"sess_*\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_USR=`eval_bckgrd "find /usr -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"ssh*config\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_VAR=`eval_bckgrd "find /var -name \"access.log\" -o -name \"*.pfx\" -o -name \"settings.php\" -o -name \"ftp.ini\" -o -name \".bashrc\" -o -name \"ipsec.secrets\" -o -name \"wp-config.php\" -o -name \"legacy_credentials.db\" -o -name \"drives.xml\" -o -name \"setupinfo.bak\" -o -name \"ipsec.conf\" -o -name \"*.crt\" -o -name \"access_tokens.db\" -o -name \"scclient.exe\" -o -name \"hostapd.conf\" -o -name \"authorized_hosts\" -o -name \"*.jks\" -o -name \"rsyncd.secrets\" -o -name \"cesi.conf\" -o -name \"accessTokens.json\" -o -name \"docker-compose.yml\" -o -name \"*vnc*.c*nf*\" -o -name \"wcx_ftp.ini\" -o -name \"KeePass.enforced*\" -o -name \".pypirc\" -o -name \"credentials\" -o -name \"*.keyring\" -o -name \".git-credentials\" -o -name \"tomcat-users.xml\" -o -name \"known_hosts\" -o -name \"recentservers.xml\" -o -name \"winscp.ini\" -o -name \"*.ovpn\" -o -name \".k5login\" -o -name \"wsl.exe\" -o -name \"my.cnf\" -o -name \"pg_hba.conf\" -o -name \"kadm5.acl\" -o -name \"id_rsa*\" -o -name \"000-default.conf\" -o -name \"bash.exe\" -o -name \"authorized_keys\" -o -name \".plan\" -o -name \"debian.cnf\" -o -name \"*.gnupg\" -o -name \"groups.xml\" -o -name \"scheduledtasks.xml\" -o -name \"httpd.conf\" -o -name \"passwd\" -o -name \".wgetrc\" -o -name \"*vnc*.xml\" -o -name \"sysprep.inf\" -o -name \"SYSTEM\" -o -name \"setupinfo\" -o -name \"*.swp\" -o -name \"docker.socket\" -o -name \"*.rdg\" -o -name \"*.db\" -o -name \"gvm-tools.conf\" -o -name \"*.service\" -o -name \"*.csr\" -o -name \"fastcgi_params\" -o -name \"*.der\" -o -name \"AppEvent.Evt\" -o -name \"*.key\" -o -name \"Ntds.dit\" -o -name \"sitemanager.xml\" -o -name \"software\" -o -name \"psk.txt\" -o -name \"access_tokens.json\" -o -name \"NetSetup.log\" -o -name \"iis6.log\" -o -name \".profile\" -o -name \"*.socket\" -o -name \"cloud.cfg\" -o -name \"FreeSSHDservice.ini\" -o -name \"docker.sock\" -o -name \"*.ftpconfig\" -o -name \".git\" -o -name \"*.pem\" -o -name \"azureProfile.json\" -o -name \"Dockerfile\" -o -name \"server.xml\" -o -name \"sess_*\" -o -name \"gitlab.rm\" -o -name \".github\" -o -name \"KeePass.config*\" -o -name \"rsyncd.conf\" -o -name \".gitconfig\" -o -name \"*.sqlite\" -o -name \"software.sav\" -o -name \"sentry.conf.py\" -o -name \"autologin\" -o -name \".sudo_as_admin_successful\" -o -name \"db.php\" -o -name \"SAM\" -o -name \"ddclient.conf\" -o -name \"default.sav\" -o -name \"gitlab.yml\" -o -name \"id_dsa*\" -o -name \"*.cer\" -o -name \"protecteduserkey.bin\" -o -name \"pagefile.sys\" -o -name \"mongod*.conf\" -o -name \"TokenCache.dat\" -o -name \"printers.xml\" -o -name \"ws_ftp.ini\" -o -name \"error.log\" -o -name \"credentials.db\" -o -name \"krb5.conf\" -o -name \"https.conf\" -o -name \"supervisord.conf\" -o -name \"backups\" -o -name \"*credential*\" -o -name \"AzureRMContext.json\" -o -name \"my.ini\" -o -name \"php.ini\" -o -name \"https-xampp.conf\" -o -name \"pgadmin*.db\" -o -name \"ffftp.ini\" -o -name \".env\" -o -name \"SecEvent.Evt\" -o -name \"kcpassword\" -o -name \"*.sqlite3\" -o -name \"ConsoleHost_history.txt\" -o -name \"vault-ssh-helper.hcl\" -o -name \"mosquitto.conf\" -o -name \"appcmd.exe\" -o -name \"*.gpg\" -o -name \"KeePass.ini\" -o -name \"creds*\" -o -name \"pgsql.conf\" -o -name \"index.dat\" -o -name \"kibana.y*ml\" -o -name \".ldaprc\" -o -name \".lesshst\" -o -name \"security.sav\" -o -name \".erlang.cookie\" -o -name \"system.sav\" -o -name \"*.keystore\" -o -name \"snmpd.conf\" -o -name \"sysprep.xml\" -o -name \"backup\" -o -name \"RDCMan.settings\" -o -name \"*password*\" -o -name \"ftp.config\" -o -name \"autologin.conf\" -o -name \"storage.php\" -o -name \"sites.ini\" -o -name \"config.php\" -o -name \"*.timer\" -o -name \"racoon.conf\" -o -name \"*vnc*.txt\" -o -name \"ntuser.dat\" -o -name \"*.p12\" -o -name \".msmtprc\" -o -name \"filezilla.xml\" -o -name \"*config*.php\" -o -name \".htpasswd\" -o -name \"krb5.keytab\" -o -name \"secrets.yml\" -o -name \"*.pgp\" -o -name \"unattend.xml\" -o -name \"datasources.xml\" -o -name \"database.php\" -o -name \"redis.conf\" -o -name \"*.viminfo\" -o -name \"postgresql.conf\" -o -name \"*.kdbx\" -o -name \"web*.config\" -o -name \"unattend.inf\" -o -name \".vault-token\" -o -name \"*vnc*.ini\" -o -name \".*_history.*\" -o -name \"elasticsearch.y*ml\" -o -name \"unattend.txt\" -o -name \"anaconda-ks.cfg\" -o -name \"hosts.equiv\" -o -name \".rhosts\" -o -name \".google_authenticator\" -o -name \"mariadb.cnf\" -o -name \"unattended.xml\" -o -name \".recently-used.xbel\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  PSTORAGE_SYSTEMD=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/systemd|^/var|^/opt|^/etc|^/snap|^/mnt|^/system|^/srv|^/lib64|^/private|^/run|^/cdrom|^/usr|^/applications|^/lib|^/tmp|^/bin|^$GREPHOMESEARCH|^/lib32|^/.cache|^/sbin|^/sys" | grep -E ".*\.service$" | sort | uniq | head -n 70)
  PSTORAGE_TIMER=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/systemd|^/var|^/opt|^/etc|^/snap|^/mnt|^/system|^/srv|^/lib64|^/private|^/run|^/cdrom|^/usr|^/applications|^/lib|^/tmp|^/bin|^$GREPHOMESEARCH|^/lib32|^/.cache|^/sbin|^/sys" | grep -E ".*\.timer$" | sort | uniq | head -n 70)
  PSTORAGE_SOCKET=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/systemd|^/var|^/opt|^/etc|^/snap|^/mnt|^/system|^/srv|^/lib64|^/private|^/run|^/cdrom|^/usr|^/applications|^/lib|^/tmp|^/bin|^$GREPHOMESEARCH|^/lib32|^/.cache|^/sbin|^/sys" | grep -E ".*\.socket$" | sort | uniq | head -n 70)
  PSTORAGE_DBUS=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/etc" | grep -E "system\.d$" | sort | uniq | head -n 70)
  PSTORAGE_MYSQL=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -v -E 'mysql/mysql' | grep -E '^/etc/.*mysql|/usr/var/lib/.*mysql|/var/lib/.*mysql' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "mysql$" | sort | uniq | head -n 70)
  PSTORAGE_MARIADB=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "mariadb\.cnf$|debian\.cnf$" | sort | uniq | head -n 70)
  PSTORAGE_POSTGRESQL=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "pgadmin.*\.db$|pg_hba\.conf$|postgresql\.conf$|pgsql\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_APACHE=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN\n$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "sites-enabled$|000-default\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_SESSIONS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E '/tmp/.*sess_.*|/var/tmp/.*sess_.*' | grep -E "^/var|^/private|^/tmp|^/mnt" | grep -E "sess_.*$" | sort | uniq | head -n 70)
  PSTORAGE_PHP_FILES=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*config.*\.php$|database\.php$|db\.php$|storage\.php$|settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_WORDPRESS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "wp-config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_DRUPAL=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E '/default/settings.php' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "settings\.php$" | sort | uniq | head -n 70)
  PSTORAGE_MOODLE=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E 'moodle/config.php' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "config\.php$" | sort | uniq | head -n 70)
  PSTORAGE_TOMCAT=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "tomcat-users\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_MONGO=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "mongod.*\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_SUPERVISORD=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "supervisord\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_CESI=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "cesi\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_RSYNC=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "rsyncd\.conf$|rsyncd\.secrets$" | sort | uniq | head -n 70)
  PSTORAGE_HOSTAPD=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "hostapd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_ANACONDA_KS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "anaconda-ks\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_RACOON=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "racoon\.conf$|psk\.txt$" | sort | uniq | head -n 70)
  PSTORAGE_VNC=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN\n$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.vnc$|.*vnc.*\.c.*nf.*$|.*vnc.*\.ini$|.*vnc.*\.txt$|.*vnc.*\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_LDAP=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "ldap$" | sort | uniq | head -n 70)
  PSTORAGE_OPENVPN=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.ovpn$" | sort | uniq | head -n 70)
  PSTORAGE_SSH=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "id_dsa.*$|id_rsa.*$|known_hosts$|authorized_hosts$|authorized_keys$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSB4=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib.*' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.pem$|.*\.cer$|.*\.crt$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSBIN=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.csr$|.*\.der$" | sort | uniq | head -n 70)
  PSTORAGE_CERTSCLIENT=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -v -E '^/usr/share/|^/etc/ssl/|^/usr/local/lib/|^/usr/lib/.*' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.pfx$|.*\.p12$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_AGENTS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/tmp|^/private" | grep -E "agent.*$" | sort | uniq | head -n 70)
  PSTORAGE_SSH_CONFIG=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/usr|^$GREPHOMESEARCH" | grep -E "ssh.*config$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_CREDENTIALS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN\n$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "credentials$|credentials\.db$|legacy_credentials\.db$|access_tokens\.db$|access_tokens\.json$|accessTokens\.json$|azureProfile\.json$|TokenCache\.dat$|AzureRMContext\.json$|\.bluemix$" | sort | uniq | head -n 70)
  PSTORAGE_KERBEROS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "krb5\.conf$|krb5\.keytab$|\.k5login$|kadm5\.acl$" | sort | uniq | head -n 70)
  PSTORAGE_KIBANA=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "kibana\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_KNOCKD=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E '/etc/init.d/' | grep -E "^/etc" | grep -E ".*knockd.*$" | sort | uniq | head -n 70)
  PSTORAGE_LOGSTASH=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "logstash$" | sort | uniq | head -n 70)
  PSTORAGE_ELASTICSEARCH=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "elasticsearch\.y.*ml$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_HELPER=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "vault-ssh-helper\.hcl$" | sort | uniq | head -n 70)
  PSTORAGE_VAULT_SSH_TOKEN=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.vault-token$" | sort | uniq | head -n 70)
  PSTORAGE_COUCHDB=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "couchdb$" | sort | uniq | head -n 70)
  PSTORAGE_REDIS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "redis\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_MOSQUITTO=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "mosquitto\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_NEO4J=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "neo4j$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUD_INIT=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "cloud\.cfg$" | sort | uniq | head -n 70)
  PSTORAGE_ERLANG=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.erlang\.cookie$" | sort | uniq | head -n 70)
  PSTORAGE_GMV_AUTH=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "gvm-tools\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IPSEC=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "ipsec\.secrets$|ipsec\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_IRSSI=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.irssi$" | sort | uniq | head -n 70)
  PSTORAGE_KEYRING=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN\n$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "keyrings$|.*\.keyring$|.*\.keystore$|.*\.jks$" | sort | uniq | head -n 70)
  PSTORAGE_FILEZILLA=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN\n$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "filezilla$|filezilla\.xml$|recentservers\.xml$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUP_MANAGER=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "storage\.php$|database\.php$" | sort | uniq | head -n 70)
  PSTORAGE_SPLUNK=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "passwd$" | sort | uniq | head -n 70)
  PSTORAGE_GITLAB=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -v -E '/lib' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "secrets\.yml$|gitlab\.yml$|gitlab\.rm$" | sort | uniq | head -n 70)
  PSTORAGE_PGP_GPG=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -v -E 'README.gnupg' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.pgp$|.*\.gpg$|.*\.gnupg$" | sort | uniq | head -n 70)
  PSTORAGE_CACHE_VI=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.swp$|.*\.viminfo$" | sort | uniq | head -n 70)
  PSTORAGE_DOCKER=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "docker\.socket$|docker\.sock$|Dockerfile$|docker-compose\.yml$" | sort | uniq | head -n 70)
  ...
  PSTORAGE_AUTOLOGIN=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "autologin$|autologin\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_FASTCGI=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "fastcgi_params$" | sort | uniq | head -n 70)
  PSTORAGE_SNMP=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "snmpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_PYPIRC=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.pypirc$" | sort | uniq | head -n 70)
  PSTORAGE_POSTFIX=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "postfix$" | sort | uniq | head -n 70)
  PSTORAGE_CLOUDFLARE=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.cloudflared$" | sort | uniq | head -n 70)
  PSTORAGE_HISTORY=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\..*_history\..*$" | sort | uniq | head -n 70)
  PSTORAGE_HTTP_CONF=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "httpd\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_HTPASSWD=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.htpasswd$" | sort | uniq | head -n 70)
  PSTORAGE_LDAPRC=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.ldaprc$" | sort | uniq | head -n 70)
  PSTORAGE_ENV=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.env$" | sort | uniq | head -n 70)
  PSTORAGE_MSMTPRC=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.msmtprc$" | sort | uniq | head -n 70)
  PSTORAGE_GITHUB=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.github$|\.gitconfig$|\.git-credentials$|\.git$" | sort | uniq | head -n 70)
  PSTORAGE_SVN=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.svn$" | sort | uniq | head -n 70)
  PSTORAGE_KEEPASS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.kdbx$|KeePass\.config.*$|KeePass\.ini$|KeePass\.enforced.*$" | sort | uniq | head -n 70)
  PSTORAGE_FTP=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.ftpconfig$|ffftp\.ini$|ftp\.ini$|ftp\.config$|sites\.ini$|wcx_ftp\.ini$|winscp\.ini$|ws_ftp\.ini$" | sort | uniq | head -n 70)
  PSTORAGE_BIND=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/usr|^/var|^/etc" | grep -E "bind$" | sort | uniq | head -n 70)
  PSTORAGE_SEEDDMS=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "seeddms.*$" | sort | uniq | head -n 70)
  PSTORAGE_DDCLIENT=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "ddclient\.conf$" | sort | uniq | head -n 70)
  PSTORAGE_KCPASSWORD=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "kcpassword$" | sort | uniq | head -n 70)
  PSTORAGE_SENTRY=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN\n$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "sentry$|sentry\.conf\.py$" | sort | uniq | head -n 70)
  PSTORAGE_STRAPI=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "environments$" | sort | uniq | head -n 70)
  PSTORAGE_CACTI=$(echo -e "$FIND_DIR_ETC\n$FIND_DIR_USR\n$FIND_DIR_VAR\n$FIND_DIR_OPT\n$FIND_DIR_CDROM\n$FIND_DIR_SBIN\n$FIND_DIR_TMP\n$FIND_DIR_SNAP\n$FIND_DIR_HOMESEARCH\n$FIND_DIR_APPLICATIONS\n$FIND_DIR_BIN\n$FIND_DIR_MNT\n$FIND_DIR_PRIVATE\n$FIND_DIR_MEDIA\n$FIND_DIR_CACHE\n$FIND_DIR_SRV"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "cacti$" | sort | uniq | head -n 70)
  PSTORAGE_WGET=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.wgetrc$" | sort | uniq | head -n 70)
  PSTORAGE_INTERESTING_LOGS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "access\.log$|error\.log$" | sort | uniq | head -n 70)
  PSTORAGE_OTHER_INTERESTING_FILES=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "\.bashrc$|\.google_authenticator$|hosts\.equiv$|\.lesshst$|\.plan$|\.profile$|\.recently-used\.xbel$|\.rhosts$|\.sudo_as_admin_successful$" | sort | uniq | head -n 70)
  PSTORAGE_WINDOWS_FILES=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "unattend\.inf$|.*\.rdg$|AppEvent\.Evt$|ConsoleHost_history\.txt$|FreeSSHDservice\.ini$|NetSetup\.log$|Ntds\.dit$|protecteduserkey\.bin$|RDCMan\.settings$|SAM$|SYSTEM$|SecEvent\.Evt$|appcmd\.exe$|bash\.exe$|datasources\.xml$|default\.sav$|drives\.xml$|groups\.xml$|https-xampp\.conf$|https\.conf$|iis6\.log$|index\.dat$|my\.cnf$|my\.ini$|ntuser\.dat$|pagefile\.sys$|php\.ini$|printers\.xml$|recentservers\.xml$|scclient\.exe$|scheduledtasks\.xml$|security\.sav$|server\.xml$|setupinfo$|setupinfo\.bak$|sitemanager\.xml$|sites\.ini$|software$|software\.sav$|sysprep\.inf$|sysprep\.xml$|system\.sav$|unattend\.txt$|unattend\.xml$|unattended\.xml$|wcx_ftp\.ini$|ws_ftp\.ini$|web.*\.config$|winscp\.ini$|wsl\.exe$" | sort | uniq | head -n 70)
  PSTORAGE_DATABASE=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -v -E '/man/|/usr/|/var/cache/' | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*\.db$|.*\.sqlite$|.*\.sqlite3$" | sort | uniq | head -n 70)
  PSTORAGE_BACKUPS=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E "backup$|backups$" | sort | uniq | head -n 70)
  PSTORAGE_PASSWORD_FILES=$(echo -e "$FIND_SYSTEMD\n$FIND_LIB64\n$FIND_LIB32\n$FIND_SYSTEM\n$FIND_CACHE\n$FIND_LIB\n$FIND_APPLICATIONS\n$FIND_USR\n$FIND_ETC\n$FIND_BIN\n$FIND_SYS\n$FIND_OPT\n$FIND_TMP\n$FIND_CDROM\n$FIND_VAR\n$FIND_HOMESEARCH\n$FIND_MNT\n$FIND_SRV\n$FIND_SNAP\n$FIND_PRIVATE\n$FIND_SBIN\n$FIND_MEDIA\n$FIND_RUN"  | grep -E "^/media|^/applications|^/srv|^/.cache|^/sbin|^/tmp|^/var|^/snap|^/bin|^/opt|^/etc|^$GREPHOMESEARCH|^/private|^/cdrom|^/usr|^/mnt" | grep -E ".*password.*$|.*credential.*$|creds.*$|.*\.key$" | sort | uniq | head -n 70)
